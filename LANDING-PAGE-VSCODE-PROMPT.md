...
1. `portpagos-lovable-prompt.md` — the full brand spec, color palette, copy,
...
- Use the exact copy from `portpagos-lovable-prompt.md` for each section. Do
  not rephrase.
...
- Making a copy choice that deviates from `portpagos-lovable-prompt.md`.
